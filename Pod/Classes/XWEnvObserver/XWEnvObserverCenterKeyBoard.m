...
static XWEnvObserverCenterKeyboard *defaultCenter;

@interface XWEnvObserverCenterKeyboard ()
- (void)appNotification:(NSNotification *)notification;
@end

@implementation XWEnvObserverCenterKeyboard
+ (XWEnvObserverCenterKeyboard *)defaultCenter {
    if (!defaultCenter) {
        defaultCenter = [[XWEnvObserverCenterKeyboard alloc] init];
    }
...
- (void)appNotification:(NSNotification *)notification {
    ...
    for (XWObserver * ob in _observersAry) {
        id<XWEnvObserverKeyboardProtocol> observer = ob.observer;
